    ...
    <>
      {
        loader ? <div className='h-screen w-full flex justify-center items-center'><span className="loader m-10"></span></div> :
          <>
            ...
            {/* overview */}
            <h2 className='text-white text-center pt-5 px-3 md:px-6 lg:px-20 font-Roboto text-[18px]'>{moviedet.overview}</h2>

            <div className='text-blue-100 font-semibold my-6 flex justify-center'>
